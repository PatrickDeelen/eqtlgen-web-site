...
`wget https://github.com/nextflow-io/nextflow/releases/download/v21.10.0/nextflow-21.10.0-all`

- Rename the Nextflow v21.10.6 executable file:

`mv nextflow-21.10.0-all nextflow`
...
You should see the message with Nextflow version number 21.10.0.
...
## Offline files for [Data QC pipeline](eQTLGen-p2-cookbook.html#1-data-qc)

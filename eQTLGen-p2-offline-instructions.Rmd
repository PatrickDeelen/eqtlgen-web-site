...
- Get eQTLGen phase II offline files:
  `wget https://www.dropbox.com/s/zticzqos052dtxp/eQTLGenP2OfflineFiles.tar.gz?dl=1 -O eQTLGenP2OfflineFiles.tar.gz`
- Get the md5sum file:
  `wget https://www.dropbox.com/s/889gifnwc95fjy2/eQTLGenP2OfflineFiles.tar.gz.md5?dl=1 -O eQTLGenP2OfflineFiles.tar.gz.md5`
...
`cp -R eQTLGenP2OfflineFiles/2_Imputation_additional_files/singularity_img 2_Imputation/eQTLGenImpute/.`

`cp -R eQTLGenP2OfflineFiles/3_ConvertVcf2Hdf5_additional_files/singularity_img 3_ConvertVcf2Hdf5/ConvertVcf2Hdf5/.`

`cp -R eQTLGenP2OfflineFiles/4_PerCohortPreparations/singularity_img 4_PerCohortPreparations/PerCohortDataPreparations/.`
